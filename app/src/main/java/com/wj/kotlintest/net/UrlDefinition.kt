...
object UrlDefinition {
    ...
    private val API_KEY = BuildConfig.API_KEY // add your API key here

    val BASE_URL = SCHEME + API_DOMAIN

    val POSTER_PATH = "http://image.tmdb.org/t/p/w342"

    val GET_HIGHEST_RATED_MOVIES = "http://api.themoviedb.org/3/discover/movie?vote_count.gte=500&language=zh&sort_by=vote_average.desc&api_key=" + API_KEY
